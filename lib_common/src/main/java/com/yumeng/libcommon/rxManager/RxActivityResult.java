 ...
 *                 .startIntent(Intent(context, FrequentContactsDetailsActivity::class.java))
 *                 .subscribe { result ->
 *                     if (result.resultCode() == RESULT_OK) {
 *                         cvContact.visibility = View.GONE
 *                         tvFrequentContacts.visibility = View.VISIBLE
 *                     }
 *
 *                 }
 *         }
...
public final class RxActivityResult {
    ...
    public static class Builder<T> {
        ...
        /**
         * 跳转intent
         * 可以带 参数 OnPreResult onPreResult
         * @param intent
         * @return
         */
