 ...
 */
package com.yumeng.libbase.activity.matisse.utils;
...
import com.yumeng.libbase.activity.matisse.matisse.IncapableCause;
...
public final class PhotoMetadataUtils {
    ...
    public static Point getBitmapBound(ContentResolver resolver, Uri uri) {
        InputStream is = null;
        try {
            String realFilePath = FileUtils.getRealFilePath(AppContextWrapper.Companion.getApplicationContext(), uri);
    ...
    public static float getSizeInMB(long sizeInBytes) {
        float result = ((float) sizeInBytes / 1024 / 1024);
        return Float.valueOf(new DecimalFormat("0.0").format(result));
    }

    public static float getSizeInMB_NoDecimalFormat(long sizeInBytes) {
        float result = ((float) sizeInBytes / 1024 / 1024);
        return result;
    }

    public static float getSizeInKB(long sizeInBytes) {
        float result = ((float) sizeInBytes / 1024);
        return Float.valueOf(new DecimalFormat("0.0").format(result));
    }
}
