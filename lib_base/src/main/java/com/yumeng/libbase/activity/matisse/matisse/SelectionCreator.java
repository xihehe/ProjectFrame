...
import com.yumeng.libbase.activity.matisse.MatisseActivity;
import com.yumeng.libbase.activity.matisse.listener.OnCheckedListener;
import com.yumeng.libbase.activity.matisse.listener.OnSelectedListener;
import com.yumeng.libbase.activity.matisse.utils.Filter;
...
public final class SelectionCreator {
    ...
    public SelectionCreator crypto(boolean isCrypto) {
        mSelectionSpec.isCrypto = isCrypto;
        return this;
    }
    ...
    /**
     * Set com.yumeng.aillo.core.listener for callback immediately when user select or unselect something.
     * <p>
    ...
    /**
     * Set com.yumeng.aillo.core.listener for callback immediately when user check or uncheck original.
     *
     * @param listener {@link OnSelectedListener}
     * @return {@link SelectionCreator} for fluent API.
     */
    ...
    //选择视频的时候是否单选
    public SelectionCreator setVideoIsSingle(boolean isSingleSelect){
        mSelectionSpec.isSingleVideo = isSingleSelect;
        return this;
    }
