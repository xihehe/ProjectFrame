...
import com.yumeng.libcommon.listener.AnimationCompleteListener;
    ...
    private void initialize() {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                if (listener != null) listener.onQueryTextSubmit(query);
                return true;
            }

            @Override
            public boolean onQueryTextChange(String newText) {
                if (listener != null) listener.onSearchTextChange(newText);
                return false;
            }
        });
